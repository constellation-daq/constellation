...
CMDPPool::socket_pair CMDPPool::find_socket(std::string_view host, sockets_map& sockets) {
...
void CMDPPool::scribe(socket_pair& socket_pair, std::string_view topic, bool subscribe) {
...
void CMDPPool::scribe_all(sockets_map& sockets, std::string_view topic, bool subscribe) {
